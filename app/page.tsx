...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-page">
      <PageHeader
        eyebrow="SV 1945 Untereuerheim"
        title="Turniere"
        subtitle="Live-Spielpläne, Tabellen und Ergebnisse aus dem Vereinsheim. Tippe ein Turnier an, um die aktuellen Spiele zu sehen."
        trailing={
          <a
            href="https://sv-untereuerheim.de"
            target="_blank"
            rel="noreferrer"
            className="hidden sm:inline-flex items-center gap-1 text-xs font-medium text-brand-50/90 hover:text-white transition-colors"
          >
      ...
      <main
        id="main"
        tabIndex={-1}
        className="mx-auto max-w-4xl px-4 pt-10 pb-16 sm:pt-12 sm:pb-24"
      >
        <section>
